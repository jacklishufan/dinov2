...
torchrun     --standalone     --nnodes=1     --nproc-per-node=1     dinov2/train/train.py     --config-file dinov2/configs/train/vit_s14_short.yaml     --output-dir output_dir3     train.dataset_path=ImageNet:split=TRAIN:root=/home/jacklishufan/imagenet/ILSVRC/in1k:extra=/home/jacklishufan/imagenet/extra
torchrun \
    --standalone \
    --nnodes=1 \
    --nproc-per-node=4 \
